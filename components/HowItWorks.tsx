...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="relative py-[var(--section-padding)] overflow-hidden">
      {/* Background orbs */}
      ...
      <div className="container-main relative">
        ...
        {/* Sticky card stack — Webflow: .work-process-card with sticky positioning */}
        <div className="max-w-[720px] mx-auto">
          {STEPS.map((step) => (
            <div key={step.num} className="sticky-card glass-card relative overflow-hidden p-8 md:p-10">
              ...
              <div className="relative z-1">
                ...
                <div className="flex items-center gap-5 mb-6">
                  {/* Process number — Webflow: .process-number (60×60, Playfair italic) */}
